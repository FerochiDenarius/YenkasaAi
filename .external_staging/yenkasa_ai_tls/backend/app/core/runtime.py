...
class IntelligenceRuntime:
    def __init__(self, settings) -> None:
        ...
        self.events = EventService(settings, self.mongo, self.yme, self.security)
    ...
    async def system_health(self) -> dict:
        ...
        components["github"] = {
            ...
            "metrics": {
                ...
                "metadata_cache_ttl_s": self.settings.github_metadata_cache_ttl_s,
                "request_timeout_s": {"connect": GITHUB_TIMEOUT[0], "read": GITHUB_TIMEOUT[1]},
                "rate_limit": self.github.rate_limit_status(),
